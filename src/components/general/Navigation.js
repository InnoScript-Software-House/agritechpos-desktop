...
import { BsFillInboxesFill, BsFillFileEarmarkTextFill, BsCartCheckFill, BsLaptopFill, BsCreditCard, BsFillPersonFill, BsFillPersonLinesFill, BsFillGearFill, BsFillFilePersonFill } from 'react-icons/bs';
...
const menus = [
    ...
    { label: `${t('customer-page')}`, url: "/customer", icon: <BsFillPersonFill className="me-2" size={20} /> },
    ...
    { label: `${t('logout-page')}`, url: "/logout", icon: <BsCreditCard className="me-2" size={20} /> }
];
