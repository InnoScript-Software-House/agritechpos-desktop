...
export const InvoiceReportPage = () => {
    ...
    const print = async () => {
        ...
        const options = {
            silent: localStorage.getItem('SILENT_PRINT') ? Boolean(localStorage.getItem('SILENT_PRINT')) : true,
            printBackground: localStorage.getItem('PRINT_BACKGROUND') ? Boolean(localStorage.getItem('PRINT_BACKGROUND')) : true,
            color: localStorage.getItem('COLOR_PRINT') ? Boolean(localStorage.getItem('COLOR_PRINT')) : true,
            margin: {
                marginType: 'printableArea'
            },
            landscape: localStorage.getItem('PRINT_LANDSCAPE') ? Boolean(localStorage.getItem('PRINT_LANDSCAPE')) : false,
            pagesPerSheet: 1,
            collate: false,
            copies: localStorage.getItem('PRINT_NUMBER') ? Number(localStorage.getItem('PRINT_NUMBER')) : 2,
            header: localStorage.getItem('INVOICE_HEADER') ? localStorage.getItem('INVOICE_HEADER') : 'AgriTech POS',
            footer: localStorage.getItem('INVOICE_FOOTER') ? localStorage.getItem('INVOICE_FOOTER') : 'AgriTech POS',
        };
